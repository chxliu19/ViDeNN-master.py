...
parser.add_argument('--save_dir', dest='save_dir', default='./data/test/temporal_denoised',
...
def denoiserTrain(TemporalDenoiser, lr):
    ...
    TemporalDenoiser.train(data, data_noisy, eval_data, eval_data_noisy, batch_size=args.batch_size,
